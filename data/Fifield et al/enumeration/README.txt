This file is an enumeration of all valid 3 district partitions of the Fifield et al dataset,
along with some partisan metrics.
...
precinct # and the value being the assigned district. Districts are numbered in canonical form.
