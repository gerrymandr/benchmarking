This folder contains data used in testing the performance of RunDMCMC.


All data is stored as .p files using the pickle import. Each file represents a single python
...
import pickle
import bz2
new_data = pickle.load(bz2.BZ2File(new_file_name,'rb'))
